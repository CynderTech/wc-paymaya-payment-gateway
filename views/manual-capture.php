<?php if (!defined('ABSPATH')) { exit; } ?>
    ...
    <table class="wc-order-totals" style="border-top: 1px solid #999; margin-top:12px; padding-top:12px">
        ...
        <tr>
            ...
            <td width="1%"></td>
            <td class="total"><?php echo wp_kses_post(wc_price($capturedAmount, $order->get_currency())) ?></td>
        </tr>
        <tr>
            <td class="label">Remaining order total:</td>
            <td width="1%"></td>
            <td class="total"><?php echo wp_kses_post(wc_price($balance, $order->get_currency())) ?></td>
        </tr>
    </table>
</div>
        ...
        <tbody id="capture-items-table-body">
            <tr>
                ...
                <td class="total total-authorized">
                    <span class="woocommerce-Price-amount amount"><?php echo wp_kses_post(wc_price($authorizedAmount, $order->get_currency())) ?></span>
                </td>
            </tr>
            <tr>
                <td class="label">Amount already captured:</td>
                ...
                <td class="total total-captured">
                    <span class="woocommerce-Price-amount amount"><?php echo wp_kses_post(wc_price($capturedAmount, $order->get_currency())) ?></span>
                </td>
            </tr>
            <tr>
                <td class="label">Remaining order total:</td>
                ...
                <td class="total total-remaining">
                    <span class="woocommerce-Price-amount amount"><?php echo wp_kses_post(wc_price($balance, $order->get_currency())) ?></span>
                </td>
            </tr>
            <tr>
